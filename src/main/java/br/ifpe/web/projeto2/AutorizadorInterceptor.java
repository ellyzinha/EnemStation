...
public class AutorizadorInterceptor implements HandlerInterceptor {
    ...
    private static final String[] RECURSOS_USUARIO = {"/loginGmail", "/material_disciplina", "esquecerSenhaForm", "/editar_plano", "/perfil", "/desempenho", "/lista_material/", "/questoes", "/addUsuario", "/listaQuestoes", "/salvarResposta"};
